...
namespace Cynthia.Web.Controls.DatePicker
{
    ...
    public class DatePickerConfiguration
    {
        ...
        public static DatePickerConfiguration GetConfig()
        {
            ...
            if (
                (HttpRuntime.Cache["CDatePickerConfig"] != null)
                && (HttpRuntime.Cache["CDatePickerConfig"] is DatePickerConfiguration)
            )
            {
                return (DatePickerConfiguration)HttpRuntime.Cache["CDatePickerConfig"];
            }
            else
            {
                String configFileName = "CDatePicker.config";
                if (ConfigurationManager.AppSettings["CDatePickerConfigFileName"] != null)
                {
                    configFileName
                        = ConfigurationManager.AppSettings["CDatePickerConfigFileName"];
                }
