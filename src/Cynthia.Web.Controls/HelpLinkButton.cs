...
///		
///     This control is really just designed for use in Cynthia
///     and external projects that plug into Cynthia.
///     
...
{
    /// <summary>
    /// This control is deprecated, you should use the <portal:CHelpLink from the Cynthia.Web project instead of this one.
    /// </summary>
    [Obsolete("This is a deprecated control, you should use the CHelpLink from the Cynthia.Web project.")]
