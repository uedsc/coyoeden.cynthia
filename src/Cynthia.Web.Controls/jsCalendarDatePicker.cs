...
namespace Cynthia.Web.Controls
{
	...
	///		
	///		example usage: 
	///		<%@ Register TagPrefix="mp" Namespace="Cynthia.Web.Controls" Assembly="Cynthia.Web.Controls" %>
	///		
	///		See instructions here:
    ///     http://www.vivasky.com/datepicker.aspx
	///									
	///		
	/// </summary>
	...
	public class jsCalendarDatePicker :  WebControl, INamingContainer
	{
		...
		[Bindable(true), Category("Appearance"), DefaultValue(CalendarTheme.CalendarCyn)]
		public CalendarTheme Theme
		{
			get { return (ViewState["Theme"] != null ? (CalendarTheme)ViewState["Theme"] : CalendarTheme.CalendarCyn); }
