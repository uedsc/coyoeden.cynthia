...
namespace Cynthia.Web.Controls.google
{
    ...
    public class GMapBasePanel : Panel
    {
        ...
        /// <summary>
        /// This should be the path to the folder containing Cynthia custom javascript for working with google APIs
        ...
        private void IncludeGMapScript()
        {
            ...
            Page.ClientScript.RegisterClientScriptBlock(
                typeof(Page),
                "Cgmaputils", "\n<script src=\""
                + Page.ResolveUrl(googleJsBasePath + "Cgmaputils.js") + "\" type=\"text/javascript\"></script>");
