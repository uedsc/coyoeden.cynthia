    ...
    public class EventCalendarControl : System.Web.UI.WebControls.CompositeDataBoundControl
    {
        ...
        *********************************************************************************/
        ...
        protected override int CreateChildControls(IEnumerable dataSource, bool dataBinding)
        {
            ...
            System.Globalization.Calendar topicCalendar = DateTimeFormatInfo.CurrentInfo.Calendar;

            m_table = CreateTable(visibleDate, firstDay, topicCalendar);
            ...
            if (dataBinding)
            {
                ...
                controlsCreated += CreateDataBoundChildren(dv, m_table, todaysDate, visibleDate, topicCalendar);
            }
            else
            {
                //Get the number of templates from viewstate and instantiate the templates
                controlsCreated += createChildrenFromViewstate(m_table, todaysDate, visibleDate, topicCalendar);
            }
        ...
        //private int CreateDataBoundChildren(System.Data.DataView dv, Table table, DateTime todaysDate, DateTime visibleDate, System.Globalization.Calendar topicCalendar)
        //{
        ...
        //            //Initialize the cell
        //            CalendarDay day = getDay(d, TodaysDate, visibleDate, topicCalendar);
        ...
        private int createChildrenFromViewstate(Table table, DateTime todaysDate, DateTime visibleDate, System.Globalization.Calendar topicCalendar)
        {
        ...
        *********************************************************************************/
        ...
        private Table CreateTable(DateTime visibleDate, DateTime firstDay, System.Globalization.Calendar topicCalendar)
        {
            ...
            if (ShowTitle)
            {
                table.Rows.Add(CreateTitleRow(visibleDate, topicCalendar));
            }

            if (ShowDayHeader)
            {
                table.Rows.Add(CreateDayHeader(firstDay, visibleDate, topicCalendar));
            }
        ...
        private TableRow CreateTitleRow(DateTime visibleDate, System.Globalization.Calendar topicCalendar)
        {
            ...
            if (this.HeaderTemplate != null)
            {
                ...
                titleCell.Controls.Add(CreateStaticTitle(visibleDate, topicCalendar));
            return row;
        }

        //Creates a title block. No customization is offered, if that's needed then specify the header template.
        Control CreateStaticTitle(DateTime visibleDate, System.Globalization.Calendar topicCalendar)
        {
            ...
            PrevBtn.Text = "&lt; " + topicCalendar.AddMonths(visibleDate, -1).ToString("MMMM");
            ...
            NextBtn.Text = topicCalendar.AddMonths(visibleDate, +1).ToString("MMMM") + " &gt;";
        ...
        CalendarDay getDay(DateTime d, DateTime todaysDate, DateTime visibleDate, System.Globalization.Calendar topicCalendar)
        {
            int dayOfWeek = (int)topicCalendar.GetDayOfWeek(d);
            int dayOfMonth = topicCalendar.GetDayOfMonth(d);
            string dayNumberText = d.ToString("dd", CultureInfo.CurrentCulture);
            int visibleDateMonth = topicCalendar.GetMonth(visibleDate);

            return new CalendarDay(d,
                (dayOfWeek == 0 || dayOfWeek == 6), // IsWeekend
                d.Equals(todaysDate), // IsToday
                topicCalendar.GetMonth(d) != visibleDateMonth, // IsOtherMonth
        ...
        private TableRow CreateDayHeader(DateTime firstDay, DateTime visibleDate, System.Globalization.Calendar topicCalendar)
        {
            TableRow row = new TableRow();
            ...
            int numericFirstDay = (int)topicCalendar.GetDayOfWeek(firstDay);
