...
namespace Cynthia.Business.WebHelpers.PaymentGateway
{
    ...
    public class PayPalStandardPaymentGateway
    {
        ...
        public string GetCartUploadFormFields()
        {
            ...
            formVars.Append("<input type='hidden' name='business' value='" + HttpUtility.HtmlEncode(businessEmail) + "' /> ");
            ...
            formVars.Append("<input type='hidden' name='custom' value='" + HttpUtility.HtmlEncode(custom) + "' /> ");
            ...
            foreach (PayPalOrderItem item in items)
            {
                ...
                formVars.Append("<input type='hidden' name='item_name_" + sItemNum
                    + "' value='" + HttpUtility.HtmlEncode(item.ItemName) + "' /> ");

                formVars.Append("<input type='hidden' name='item_number_" + sItemNum
                    + "' value='" + HttpUtility.HtmlEncode(item.ItemNumber) + "' /> ");

                formVars.Append("<input type='hidden' name='quantity_" + sItemNum
                    + "' value='" + HttpUtility.HtmlEncode(item.Quantity.ToString(CultureInfo.InvariantCulture)) + "' /> ");

                formVars.Append("<input type='hidden' name='amount_" + sItemNum
                    + "' value='" + HttpUtility.HtmlEncode(itemAmount.ToString().Replace(",", ".")) + "' /> ");

                if (taxAmount > 0)
                {
                    formVars.Append("<input type='hidden' name='tax_" + sItemNum
                        + "' value='" + HttpUtility.HtmlEncode(taxAmount.ToString().Replace(",", ".")) + "' /> ");
                }
