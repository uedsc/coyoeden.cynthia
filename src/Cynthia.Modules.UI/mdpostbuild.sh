...
# link module
if [ -d ../Web/LinkModule ]; then
	rm -rf ../Web/LinkModule
fi
mkdir ../Web/LinkModule;
cp LinkModule/*.aspx ../Web/LinkModule/;
cp LinkModule/*.ascx ../Web/LinkModule/;
...
mkdir ../Web/Flickr;
# cp Flickr/*.aspx ../Web/LiveMessenger/;
