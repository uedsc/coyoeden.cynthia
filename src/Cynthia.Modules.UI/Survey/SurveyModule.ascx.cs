...
namespace SurveyFeature.UI
{
    public partial class SurveyModule : SiteModuleControl
    {
        ...
        {
            return (Request.Cookies["CSurvey"] != null && Request.Cookies["CSurvey"].Values[surveyGuid.ToString()] != null);
        }
        ...
        private Guid GetCurrentResponseGuid()
        {
            ...
            if (Request.Cookies["CSurvey"] != null)
            {
                string stringGuid = Request.Cookies["CSurvey"].Values[survey.SurveyGuid.ToString()];
                ...
                if (stringGuid != null)
                {
                    ...
                    catch (OverflowException)
                    {
                        ...
                        Response.Cookies.Remove("CSurvey");
                    }
        ...
        private void SetCookie(Guid responseGuid)
        {
            if (Request.Cookies["CSurvey"] == null)
            {
                HttpCookie cookie = new HttpCookie("CSurvey");
                Response.Cookies.Add(cookie);
            }

            if (responseGuid == Guid.Empty)
            {
                Response.Cookies["CSurvey"].Values.Remove(surveyGuid.ToString());
            }
            else
            {
                Response.Cookies["CSurvey"].Values.Set(surveyGuid.ToString(), responseGuid.ToString());
            }
        }
