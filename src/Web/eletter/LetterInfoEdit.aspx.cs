...
namespace Cynthia.Web.ELetterUI
{
    ...
    public partial class LetterInfoEditPage : CBasePage
    {
        ...
        private void PopulateLetterInfoControls()
        {
            ...
            lnkThisPage.Text = letterInfo.Title.ToString();
            lnkThisPage.ToolTip = letterInfo.Title.ToString();

            txtTitle.Text = letterInfo.Title.ToString();
            edDescription.Text = letterInfo.Description.ToString();
            ...
            txtFromAddress.Text = letterInfo.FromAddress.ToString();
            txtFromName.Text = letterInfo.FromName.ToString();
            txtReplyToAddress.Text = letterInfo.ReplyToAddress.ToString();
        ...
        private void PopulateLabels()
        {
            ...
            litHeading.Text = Resource.LetterInfoEditHeading;

            lnkAdminMenu.Text = Resource.LetterInfoAdminHeading;
            lnkAdminMenu.ToolTip = Resource.LetterInfoAdminHeading;
            lnkAdminMenu.NavigateUrl = SiteRoot + "/eletter/Admin.aspx";

            lnkThisPage.Text = Resource.LetterInfoNewLink;
            lnkThisPage.ToolTip = Resource.LetterInfoNewLink;
