...
{
    public partial class LetterDraftsPage : CBasePage
    {
        ...
        private void PopulateDraftList()
        {
            ...
            if (this.totalPages > 1)
            {
                string pageUrl = SiteUtils.GetNavigationSiteRoot()
                    + "/eletter/LettrDrafts.aspx?l=" + letterInfoGuid.ToString() + "&amp;pagenumber={0}";
        ...
        private void PopulateLabels()
        {
            ...
            litHeading.Text = Resource.NewsLetterUnsentLettersHeading;
