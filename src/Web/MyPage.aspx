<%@ Page EnableEventValidation="false" Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/layout.Master" CodeBehind="MyPage.aspx.cs"  Inherits="Cynthia.Web.UI.Pages.MyPage" %>

<%@ Register Assembly="Cynthia.Web" Namespace="Cynthia.Web.WebParts" TagPrefix="mpw" %>
...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
  ...
  <% #if!MONO %>
    ...
    <asp:LoginView ID="lvMessage" runat="server">
        <AnonymousTemplate>
        <strong><cy:SiteLabel id="lbl1" runat="server" ConfigKey="MyPageAnonymousMessage" UseLabelTag="false"> </cy:SiteLabel></strong>
        </AnonymousTemplate>
    ...
    <portal:CHelpLink ID="CynHelpLink11" runat="server" HelpKey="mypagehelp" />
    <mpw:CWebPartManager ID="WebPartManager1" runat="server" Personalization-Enabled="true" />
        ...
        <tr>
            ...
            <td valign="top">
                ...
                <asp:CatalogZone ID="CatalogZone1" runat="server">
                    <ZoneTemplate>
                        <portal:CUserCatalogPart ID="CUserCatalogPart1" runat="server" />
