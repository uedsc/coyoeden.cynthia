...
<portal:CPanel ID="mp1" runat="server" ArtisteerCssClass="art-Post" RenderArtisteerBlockContentDivs="true">
    ...
    <asp:Panel ID="pnl1" runat="server" CssClass="art-Post-inner panelwrapper orderentry admincheckout ">
        ...
        <div class="modulecontent yui-skin-sam">
            <asp:Panel ID="pnlOrderDetail" runat="server" CssClass="clear orderdetail">
                    ...
                    <fieldset>
                        ...
                        <div class="settingrow">
                            ...
                            <portal:GreyBoxHyperlink ID="lnkUserLookup" runat="server" ClientClick="return GB_showCenter(this.title, this.href, 670,600)"
                                Visible="false" />
                            <asp:Button ID="btnClearUser" runat="server" />
                ...
                <asp:Panel ID="pnlShipping" runat="server" CssClass="floatpanel ">
                    <fieldset>
                        ...
                        <div class="settingrow">
                            <portal:CButton ID="lnkCopyCustomerToShipping" runat="server" CssClass="buttonlink" CausesValidation="false" />&nbsp;&nbsp;
                            <portal:CButton ID="lnkCopyBillingToShipping" runat="server" CssClass="buttonlink" CausesValidation="false" />
                        </div>
                        <div class="settingrow">
                ...
                <div class="settingrow">
                    <portal:CButton ID="btnSave" Text="Update" runat="server" ValidationGroup="OrderInfo" />
                </div>
            </asp:Panel>
            ...
            <asp:Panel ID="pnlCheckout" runat="server" Visible="false">
                <fieldset id="frmCardInput" runat="server" class="clear">
                    ...
                    <div class="settingrow">
                        <cy:SiteLabel ID="SiteLabel10" runat="server" CssClass="settinglabel" ConfigKey="CartOrderInfoCardOwnerLastNameLabel"
                            ResourceFile="WebStoreResources" />
                    ...
                    <div class="settingrow">
                        <cy:SiteLabel ID="SiteLabel13" runat="server" ForControl="chkSendConfirmationEmail"
                ...
                <fieldset>
                    <div class="settingrow">
                        <cy:SiteLabel ID="SiteLabel15" runat="server" ForControl='txtAuthCode" ' CssClass="settinglabel"
                    ...
                    <div class="settingrow">
                        <cy:SiteLabel ID="SiteLabel16" runat="server" ForControl='txtTransactionId" ' CssClass="settinglabel"
                    ...
                    <div class="settingrow">
                        <cy:SiteLabel ID="SiteLabel17" runat="server" ForControl="chkOrderEntrySendConfirmationEamil"
                            CssClass="settinglabel" ConfigKey="SendConfirmationEmailLabel" ResourceFile="WebStoreResources" />
                        <asp:CheckBox ID="chkOrderEntrySendConfirmationEamil" runat="server" Checked="true" />
                    </div>
                    <div class="settingrow">
                        <cy:SiteLabel ID="SiteLabel14" runat="server" CssClass="settinglabel" ConfigKey="spacer" />
                        <portal:CButton ID="btnCreateOrder" runat="server" />&nbsp;&nbsp;
                    </div>
                </fieldset>
            </asp:Panel>
        </div>
