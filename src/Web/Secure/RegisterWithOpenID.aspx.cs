...
namespace Cynthia.Web.UI.Pages
{
    ...
    public partial class RegisterWithOpenId : CBasePage
    {
        ...
        private void DoNewUserLogic(OpenIdEventArgs e)
        {
            ...
            if (IsValidForUserCreation(e, claim))
            {
                ...
                else
                {
                    ...
                    // the needed data
                    string loginName
                        = e.ClaimedIdentifier.ToString().Replace("http://", string.Empty).Replace("https://", string.Empty).Replace("/", string.Empty);
            ...
            else
            {
                ...
                {
                    CookieHelper.SetSecureCookie(openIdFullNameCookieName, claim.FullName);
                }
        ...
        void btnCreateUser_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                {
                    CreateUser(openID, email, loginName, name);
                }
