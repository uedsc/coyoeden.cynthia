...
namespace Cynthia.Web.UI
{
    ...
    public class CodeEditor : TextBox
    {
        ...
        /// actually there are others too but these are the ones of interest in Cynthia
        /// </summary>
        ...
        /// probably we will not use this in Cynthia, we will use mainly the text area content
        /// </summary>
        ...
        private void SetupScript()
        {
            ...
            script.Append(",min_width:" + minWidth.ToString(CultureInfo.InvariantCulture));
            script.Append(",min_height:" + minHeight.ToString(CultureInfo.InvariantCulture));
            ...
            script.Append(",font_size:" + fontSize.ToString(CultureInfo.InvariantCulture));
