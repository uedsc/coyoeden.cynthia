...
namespace Cynthia.Web.UI
{
    ...
    requeueTimeout: 250   // ms delay for requeue 
        ...
        private void SetupInstanceScript()
        {
            ...
            {
                script.Append("$('#" + this.ClientID + " > div." + slideContainerClass + "').cycle({");
            }
            else
            {
                script.Append("$('#" + this.ClientID + "').cycle({");
            }
            ...
            if (pager.Length > 0) { script.Append(",pager:'" + pager + "'"); }
        ...
        private void ValidateSettings()
        {
            ...
            List<string> supplied = fx.SplitOnChar(',');
        ...
        private void SetupMainScript()
        {
            ...
            Page.ClientScript.RegisterClientScriptBlock(typeof(Page),
                    "jqCynthiaycle", "\n<script  src=\""
                    + Page.ResolveUrl("~/ClientScript/jqCynthia/cycle.js") + "\" type=\"text/javascript\" ></script>");
