<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="OpenIDLoginControl.ascx.cs" Inherits="Cynthia.Web.OpenIdLoginControl" %>

<portal:COpenIdLogin ID="OpenIdLogin1" runat="server" CssClass="openid_login" />
<br />
