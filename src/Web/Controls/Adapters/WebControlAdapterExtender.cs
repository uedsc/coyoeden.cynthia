...
namespace Cynthia.Web
{
    public class WebControlAdapterExtender
    {
        ...
        public void RegisterScripts()
        {
            ...
            //string filePath = "~/ClientScript/Cynthiacombined.js";
            //AdaptedControl.Page.ClientScript.RegisterClientScriptInclude(typeof(Page), "Cynthiacombined", AdaptedControl.Page.ResolveUrl(filePath));
        }
        ...
        public void RenderBeginTag(HtmlTextWriter writer, string cssClass)
        {
            ...
            if (WebConfigSettings.UseHtml5)
            {
                WriteBeginNav(writer, cssClass, id);
            }
            else
            {
