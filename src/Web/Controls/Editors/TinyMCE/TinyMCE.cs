...
namespace Cynthia.Web.Editor
{
    ...
    [Designer("Cynthia.Web.Editor.TinyMCEDesigner")]
    [ParseChildren(false)]
    public class TinyMCE : Control, IPostBackDataHandler
    {
        ...
        /// Cynthia note: not sure why this is false by default in TinyMCE
        ...
        /// 
        /// In Cynthia I made the default "top", which seems a better default
        /// to me.
        /// </summary>
        ...
        /// 
        /// In Cynthia I changed the default to left.
        /// </summary>
        ...
        private void SetupScripts()
        {
            ...
            if (defaultCulture.TextInfo.IsRightToLeft) { textDirection = "rtl"; }
