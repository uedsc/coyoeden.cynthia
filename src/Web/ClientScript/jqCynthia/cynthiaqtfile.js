 ...
 * http://qtfile.codeplex.com/license
 ...
 Adopted/Forked For Cynthia by Joe Audette 2009-12-25
    ...
    jQuery.extend(fn, {
        ...
        createFileItem: function(fileInfo) {
			...
			.click(function() {
			    ...
			    //prompt(qtfile.loc(TextLinkIntro), qtfile.getUrl(qtfile.currentFolder, jQuery(this).parent(Span).parent(Li)));
