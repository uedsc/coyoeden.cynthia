...
<script runat="server">
    ...
    {
		string file = Server.MapPath("~/ClientScript/ibox.js.aspx");
		Response.ContentType = "text/javascript";
		
		// Server-side caching
    
        Response.AddFileDependency(file);
        Response.Cache.VaryByParams["path"] = false;
...
MIT Licensed Style
*********************************************************/
var indicator_img_path = '<%= ResolveUrl("~/Data/SiteImages/ibox-indicator.gif") %>';
var close_text = '<%= Resources.Resource.iboxCloseWindow %>';
var alt_text = '<%= Resources.Resource.iboxLoading %>';
var indicator_img_html = "<img name=\"ibox_indicator\" src=\""+indicator_img_path+"\" alt=\"" +alt_text+"\" style=\"width:128px;height:128px;\"/>"; // don't remove the name
...
createIbox = function(elem) {
	...
	strHTML +=	"<a id=\"ibox_close_a\" href=\"javascript:void(null);\" class=\"iboxclose\">" + close_text + "</a></div>";
