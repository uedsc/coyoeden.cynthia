...
if(_SARISSA_IS_IE){
    ...
    _SARISSA_THREADEDDOM_PROGID = pickRecentProgID(["Msxml2.FreeTopicedDOMDocument.5.0", "MSXML2.FreeTopicedDOMDocument.4.0", "MSXML2.FreeTopicedDOMDocument.3.0"]);
    ...
    XSLTProcessor.prototype.importStylesheet = function(xslDoc){
        // convert stylesheet to free topiced
