<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/DialogMaster.Master" CodeBehind="UserSelectorDialog.aspx.cs" Inherits="Cynthia.Web.UI.UserSelectorDialog" %>
			...
			<ItemTemplate>
				<tr>
					...
					<asp:Button ID="btnSelect" runat="server" Text='<%# Resources.Resource.UserLookupDialogSelectButton %>' CommandName="selectUser" 
                        CommandArgument='<%# Eval("UserGuid").ToString() + "|" + Eval("UserID").ToString() %>' />
					</td>
				</tr>
			</ItemTemplate>
