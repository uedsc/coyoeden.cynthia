<%@ Page Language="C#" MasterPageFile="~/App_MasterPages/layout.Master" AutoEventWireup="false" CodeBehind="ChooseContent.aspx.cs" Inherits="Cynthia.Web.UI.Pages.ChooseContent" Title="Untitled Page" %>
...
<% #if!MONO %>
<portal:CDataList ID="dlWebParts" runat="server"
     RepeatColumns="3" 
