...
namespace Cynthia.Web
{
    ...
    ///
    /// </summary>
    public class CServiceHostFactory : ServiceHostFactory
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(CServiceHostFactory));

        protected override ServiceHost CreateServiceHost(Type serviceType, Uri[] baseAddresses)
        {
            CServiceHost customServiceHost;
            ...
            {
                customServiceHost = new CServiceHost(serviceType, baseAddresses[preferredHostIndex]);
                return customServiceHost;
            }

            customServiceHost = new CServiceHost(serviceType, baseAddresses[0]);
            return customServiceHost;
        }
