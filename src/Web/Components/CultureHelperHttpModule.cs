...
namespace Cynthia.Web
{
    public class CultureHelperHttpModule : IHttpModule
    {
        ...
        private void BeginRequest(object sender, EventArgs e)
        {
            ...
            // CultureInfo for the executing topic is automatically set to the 
            ...
            //by default the culture of the executing topic is set to that of the browser preferred language setting
            ...
            //below we are using a config setting to change the default behavior to force the topic to use a specific culture
            ...
            if (WebConfigSettings.UseCultureOverride)
            {
                ...
                {
                    log.Info("cannot use culture " + siteCulture.Name + " because it is a neutral culture. It cannot be used in formatting and parsing and therefore cannot be set as the topic's current culture.");
                }
                else
                {
                    try
