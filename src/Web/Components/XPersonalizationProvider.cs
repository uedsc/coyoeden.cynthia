...
namespace Cynthia.Web
{
    ...
    ///
    /// </summary>
    public class CPersonalizationProvider : PersonalizationProvider
    {
            ...
            out int totalRecords)
        {
            ...
            //CPersonalizationProviderHelper.CheckPersonalizationScope(scope);
            //CPersonalizationProviderHelper.CheckPageIndexAndSize(pageIndex, pageSize);
