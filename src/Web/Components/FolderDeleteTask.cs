...
{
    /// <summary>
    /// This is a simple task for deleting a folder asynchronously on a background topic 
    /// 
    /// </summary>
    [Serializable()]
    public class FolderDeleteTask : ITaskQueueTask
    {
        ...
        public void StartTask()
        {
            ...
            {
                throw new Exception("Couldn't queue the FolderDeleteTask on a new topic.");
            }
            ...
            log.Info("Queued Folder Delete on a new topic");
