...
namespace Cynthia.Web.UI
{
    ...
    /// 	
    /// </summary>
    public class CUserCatalogPart : CatalogPart
    {
        ...
        public override WebPart GetWebPart(WebPartDescription description)
        {
            ...
            {
                Cynthia.Business.Module module = new Cynthia.Business.Module(int.Parse(description.ID));
                ...
                if (siteModule != null)
                {
                    ...
                    Cynthia.Business.Module.UpdateCountOfUseOnMyPage(module.ModuleId, 1);
                }
            }
        ...
        public override string Title
        {
            get
            {
                return Resources.Resource.CUserCatalogPartTitle;
                //return SiteUtils.GetLocalizedValue("CUserCatalogPartTitle");
            }
            set
            {
                base.Title = value;
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (countOfWebParts > WebConfigSettings.NumberOfWebPartsToShowInMiniCatalog)
            {
                string text = "<a href='" + WebUtils.GetSiteRoot()
                              ...
                              + Resources.Resource.WebPartCatalogMoreLink
                              + "</a><br /><br />";
