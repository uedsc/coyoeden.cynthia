...
{
    class CynHtml32TextWriter : Html32TextWriter
    {
        private string formAction;
        private const string actionAttribute = "action";

        public CynHtml32TextWriter(TextWriter writer)
            : base(writer)
        {
            
        }

        public CynHtml32TextWriter(TextWriter writer, string action) : base(writer)
		{
			formAction = action;
		}
