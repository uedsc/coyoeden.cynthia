...
namespace Cynthia.FileSystem
{
    public class FileSystemConfiguration
    {
        ...
        public static FileSystemConfiguration GetConfig()
        {
            ...
            if (
                (HttpRuntime.Cache["CFileSystemConfig"] != null)
                && (HttpRuntime.Cache["CFileSystemConfig"] is FileSystemConfiguration)
            )
            {
                return (FileSystemConfiguration)HttpRuntime.Cache["CFileSystemConfig"];
            }
            else
            {
                String configFileName = "CFileSystem.config";
                if (ConfigurationManager.AppSettings["CFileSystemConfigFileName"] != null)
                {
                    configFileName = ConfigurationManager.AppSettings["CFileSystemConfigFileName"];
