...
namespace Cynthia.Web.AdminUI
{
    ...
    public partial class CoreDataPage : CBasePage
    {
        ...
        private void PopulateLabels()
        {
            ...
            litAdminHeading.Text = Resource.CoreDataAdministrationHeading;
            ...
            lnklnkGeoZone.Text = Resource.GeoZoneAdministrationLink;
            lnklnkGeoZone.NavigateUrl = SiteRoot + "/Admin/AdminGeoZone.aspx";
