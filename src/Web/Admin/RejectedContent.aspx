<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RejectedContent.aspx.cs" 
    MasterPageFile="~/App_MasterPages/layout.Master" Inherits="Cynthia.Web.AdminUI.RejectedContentPage" %>
...
<div class="modulecontent">
   ...
   <cy:CGridView ID="grdRejectedContent" runat="server" AllowPaging="false" AllowSorting="false"
    ...
    <div class="modulepager">
        <portal:CCutePager ID="pgrRejectedContent" runat="server" />
    </div>
    </div>
    </portal:CPanel>
