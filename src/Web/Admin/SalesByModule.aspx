<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/layout.Master" CodeBehind="SalesByModule.aspx.cs" Inherits="Cynthia.Web.AdminUI.SalesByModulePage" %>
...
<div class="floatpanel">
<cy:CGridView ID="grdTopItems" runat="server"
     AllowPaging="false"
     AllowSorting="false"
	 AutoGenerateColumns="false"
     EnableTheming="false"
