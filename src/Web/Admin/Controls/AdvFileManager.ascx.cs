...
namespace Cynthia.Web.AdminUI
{
    public partial class AdvFileManager : UserControl
    {
        ...
        private void SetupScripts()
        {
            ...
            script.Append("url:'" + siteRoot + "/Services/FileService.ashx?cmd=download&path={path}'");
            script.Append(",data: { }");
            script.Append("}");

            script.Append(",move: {");
            //script.Append("url: '/UserFile/FileMove?srcPath={srcPath}&destPath={destPath}'");
            script.Append("url:'" + siteRoot + "/Services/FileService.ashx?cmd=movefile&srcPath={srcPath}&destPath={destPath}'");
            ...
            script.Append("url:'" + siteRoot + "/Services/FileService.ashx?cmd=deletefile&path={path}'");
            script.Append(",method: 'GET'");
            script.Append(",data: { }");
            script.Append("}");
            ...
            script.Append("url:'" + siteRoot + "/Services/FileService.ashx?cmd=listfiles&path={path}'");
            script.Append(",method: 'GET'");
            script.Append(",data: { }");
            script.Append("}");
            ...
            script.Append("url:'" + siteRoot + "/Services/FileService.ashx?cmd=upload'");
            ...
            script.Append("url:'" + siteRoot + "/Services/FileService.ashx?cmd=createfolder&path={path}'");
            script.Append(",method: 'GET'");
            script.Append(",data: { }");
            script.Append("}");
            ...
            script.Append("url:'" + siteRoot + "/Services/FileService.ashx?cmd=movefolder&srcPath={srcPath}&destPath={destPath}'");
            script.Append(",method: 'GET'");
            script.Append(",data: { }");
            script.Append("}");
            ...
            script.Append("url:'" + siteRoot + "/Services/FileService.ashx?cmd=deletefolder&path={path}'");
            script.Append(",method: 'GET'");
            script.Append(",data: { }");
            script.Append("}");
            ...
            script.Append("url:'" + siteRoot + "/Services/FileService.ashx?cmd=listfolders'");
            script.Append(",method: 'GET'");
            script.Append(",data: { }");
            script.Append("}");
