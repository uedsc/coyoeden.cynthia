<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="AdvFileManager.ascx.cs" Inherits="Cynthia.Web.AdminUI.AdvFileManager" %>
<%@ Import Namespace="System.Linq" %>
<%@ Import Namespace="Cynthia.FileSystem" %>
<%@ Import Namespace="Cynthia.Web.Framework" %>
