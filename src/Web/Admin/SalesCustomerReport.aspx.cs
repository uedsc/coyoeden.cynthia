...
namespace Cynthia.Web.AdminUI
{
    ...
    public partial class SalesCustomerReportPage : CBasePage
    {
        ...
        private void PopulateControls()
        {
            ...
            litHeading.Text = Server.HtmlEncode(siteSettings.SiteName + " - " + Resource.CommerceReportCustomerReportHeading);
