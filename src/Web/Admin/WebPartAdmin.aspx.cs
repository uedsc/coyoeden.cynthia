...
namespace Cynthia.Web.AdminUI
{
    ...
    public partial class WebPartAdminPage : CBasePage
    {
        ...
        private void PopulateControls()
        {
            ...
            {
                lblNoAvailableWebParts.Text = Resource.WebPartAdminMediumTrustMessage;
            }
        ...
        private void BindNotInstalledWebParts()
        {
            ...
            {
                this.lblNoAvailableWebParts.Text = Resource.WebPartAllInstalledMessage;
            }
        }
        ...
        private void PopulateLabels()
        {
            ...
            this.grdAvailableParts.Columns[0].HeaderText = Resource.WebPartAvailableNameLabel;

            this.grdWebParts.Columns[1].HeaderText = Resource.WebPartTitleLabel;
            this.grdWebParts.Columns[2].HeaderText = Resource.WebPartDescriptionLabel;
            this.grdWebParts.Columns[3].HeaderText = Resource.WebPartClassNameLabel;
            this.grdWebParts.Columns[4].HeaderText = Resource.WebPartAvailableForMyPageLabel;
            this.grdWebParts.Columns[5].HeaderText = Resource.WebPartAllowMultipleInstancesOnMyPageLabel;
            this.grdWebParts.Columns[6].HeaderText = Resource.WebPartAvailableForContentSystemLabel;
