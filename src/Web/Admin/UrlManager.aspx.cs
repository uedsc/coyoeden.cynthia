...
{
    public partial class UrlManagerPage : CBasePage
    {
        ...
        private void PopulateLabels()
        {
            ...
            this.btnAddFriendlyUrl.Text = Resource.FriendlyUrlAddNewLabel;
            SiteUtils.SetButtonAccessKey
                (btnAddFriendlyUrl, AccessKeys.FriendlyUrlAddNewLabelAccessKey);

            this.btnAddExpert.Text = Resource.FriendlyUrlAddNewLabel;

            this.lblFriendlyUrlRoot.Text = this.RootUrl;
            this.lblAddMapping.Text = Resource.FriendlyUrlAddNewLabel;
