<%@ Page language="c#" Codebehind="ContentValidation.aspx.cs" AutoEventWireup="True" Inherits="Cynthia.Web.AdminUI.ContentValidation" %>
...
<HTML>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<p>When Cynthia displays untrusted content, the current cross-site scripting prevention 
			strategy validates it against XML schema that is designed to prevent inclusion of scripts.  
			If content is invalid according to the schema, Cynthia displays the reason it was 
