...
namespace Cynthia.Data
{
    ...
    public static class DBLetterSendLog
    {
        ...
        public static bool DeleteBySite(Guid siteGuid)
        {
            ...
            sqlCommand.Append("DELETE FROM cy_LetterSendLog ");
            sqlCommand.Append("WHERE ");
            sqlCommand.Append("LetterGuid IN (SELECT LetterGuid FROM cy_Letter WHERE LetterInfoGuid IN ");
            sqlCommand.Append("(SELECT LetterInfoGuid FROM cy_LetterInfo WHERE SiteGuid = :SiteGuid)) ");
            sqlCommand.Append(";");
