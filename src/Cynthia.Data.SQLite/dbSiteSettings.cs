...
namespace Cynthia.Data
{
    ...
    public static class DBSiteSettings
    {
        ...
        public static void AddFeature(Guid siteGuid, Guid featureGuid)
        {
            ...
            sqlCommand.Append("VALUES ");
            sqlCommand.Append("( ");
            sqlCommand.Append("(SELECT SiteID FROM cy_Sites WHERE SiteGuid = :SiteGuid LIMIT 1), ");
            sqlCommand.Append("(SELECT ModuleDefID FROM cy_ModuleDefinitions WHERE Guid = :FeatureGuid LIMIT 1), ");
            sqlCommand.Append(":SiteGuid, ");
            sqlCommand.Append(":FeatureGuid ");
            sqlCommand.Append(") ;");
