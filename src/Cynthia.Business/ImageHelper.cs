...
namespace Cynthia.Business
{
	...
	public sealed class ImageHelper
	{
        ...
        public static void ResizeImage(string imageFilePath, string mimeType, int maxWidth, int maxHeight)
        {
            bool allowEnlargement = false;
            ResizeImage(imageFilePath, mimeType, maxWidth, maxHeight, allowEnlargement);
        ...
        /// <param name="maxWidth"></param>
        /// <param name="maxHeight"></param>
        public static void ResizeAndSquareImage(string imageFilePath, string mimeType, int sideLength)
        {
            if (!File.Exists(imageFilePath)) { return; }
       ...
       /// <param name="x"></param>
       /// <param name="y"></param>
        public static void CropImage(string imageFilePath, string destFilePath, string mimeType, int width, int height, int x, int y)
        {
            if (!File.Exists(imageFilePath)) { return; }
