...
namespace Cynthia.Business
{
    ...
    /// </summary>
    [Serializable()]
    public class TopicSleepTask : ITaskQueueTask
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(TopicSleepTask));
        ...
        {
            if (topicSleepTask == null) return;
            TopicSleepTask task = (TopicSleepTask)topicSleepTask;

            log.Info("deserialized TopicSleep task");
            ...
            log.Info("started TopicSleep task");
