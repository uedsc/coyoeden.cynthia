...
namespace Cynthia.Business
{
    ...
    public class GalleryImage : IIndexableContent
    {
        ...
        public GalleryImage(int galleryId, string storagePath)
        {
        ...
        public GalleryImage(int galleryId, int itemId, string storagePath)
        {
            this.moduleID = galleryId;
            this.storageFolderPath = storagePath;
        ...
        {
            if (File.Exists(this.storageFolderPath + "FullSizeImages" + Path.DirectorySeparatorChar + this.imageFile))
            {
                File.Delete(this.storageFolderPath + "FullSizeImages" + Path.DirectorySeparatorChar + this.imageFile);
            }

            if (File.Exists(this.storageFolderPath + "WebImages" + Path.DirectorySeparatorChar + this.webImageFile))
            {
                File.Delete(this.storageFolderPath + "WebImages" + Path.DirectorySeparatorChar + this.webImageFile);
            }

            if (File.Exists(this.storageFolderPath + "Thumbnails" + Path.DirectorySeparatorChar + this.thumbnailFile))
            {
                File.Delete(this.storageFolderPath + "Thumbnails" + Path.DirectorySeparatorChar + this.thumbnailFile);
            }
